...
const Index = () => {
  const subjects = [
    { name: '代数学', description: '方程式、関数、行列など', color: 'from-pink-500 to-red-500' },
    { name: '幾何学', description: '図形、空間、測量など', color: 'from-purple-500 to-indigo-500' },
    { name: '微積分', description: '極限、微分、積分など', color: 'from-blue-500 to-teal-500' },
    { name: '統計学', description: 'データ分析、確率論など', color: 'from-green-500 to-lime-500' },
    { name: '数論', description: '整数論、暗号理論など', color: 'from-yellow-500 to-amber-500' },
    { name: '離散数学', description: 'グラフ理論、組み合わせ論など', color: 'from-orange-500 to-red-500' },
  ];
